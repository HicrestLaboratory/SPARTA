...
enum MultiplicationAlgo {NO_MULT, cublas_gemm, cusparse_spmm, cusparse_bellpack, cublas_vbr, cublas_vbr_fixed, cublas_vbr_inverted, cublas_vbr_batched, cutlass_bellpack, cutlass_gemm, cutlas_vbr};
